...
path = r'D:\0---Program\Projects\aimbot\yolov5-master\yolov5-master\output\20230526170401_log.json'
# 读取日志文件
import json
...
def check_video_logs(path):
    ...
    for video_name, video_data in data.items():
        ...
        if (category_num == 31 and category != 0) or (category_num == 30 and category != 3):
            incorrect += 1
